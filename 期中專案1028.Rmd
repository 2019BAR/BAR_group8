...
step2：從銷售額前10名的商品種類取出總和營收佔整個平台前30%的產品類別
...
```{r}
plot(cat_health_beauty$month, cat_health_beauty$totalRev, type='l', col='red', xlim=as.Date(c('2017-01-01','2018-08-01'))) 

lines(cat_watches_gifts$month, cat_watches_gifts$totalRev, type='l', col='gold')
...
```
```{r}
save(Monthly,cat_bed_bath_table, cat_health_beauty, cat_sports_leisure, cat_watches_gifts, adjust_Monthly, category_with_city, category_without_city, gg, top_4_Monthly, top10, category,file="1027.rdata")
```
