...
##### Step5：總營銷建議
```{r}
save(Monthly,cat_bed_bath_table, cat_health_beauty, cat_sports_leisure, cat_watches_gifts, adjust_Monthly, category_with_city, category_without_city, top_4_Monthly, top10, category,file="1027.rdata")
```
