...
```{r}
A = read.csv('C:/BAR_group8/unit02/data/CPSData.csv')
MetroAreaCode = read.csv('C:/BAR_group8/unit02/data/MetroAreaCodes.csv')
CountryOfBirthcode = read.csv('C:/BAR_group8/unit02/data/CountryCodes.csv')
nrow(A)
```
...
```{r}
tapply(A$Hispanic, A$MetroArea, mean, na.rm = TRUE) %>% sort %>% tail
```
