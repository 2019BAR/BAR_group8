...
```{r}
IBM = read.csv('C:/Users/user/Desktop/R/data and code/unit02cd/other data/IBMStock.csv')
GE = read.csv('C:/Users/user/Desktop/R/data and code/unit02cd/other data/GEStock.csv')
PG = read.csv('C:/Users/user/Desktop/R/data and code/unit02cd/other data/ProcterGambleStock.csv')
CO = read.csv('C:/Users/user/Desktop/R/data and code/unit02cd/other data/CocaColaStock.csv')
BOE = read.csv('C:/Users/user/Desktop/R/data and code/unit02cd/other data/BoeingStock.csv')
nrow(IBM)
```
...
```{r}
plot(IBM$Date, IBM$StockPrice, type = 'l')
lines(GE$Date, GE$StockPrice, type = 'l', col = 'blue')
lines(PG$Date, PG$StockPrice, type = 'l', col = 'yellow')
lines(CO$Date, CO$StockPrice, type = 'l', col = 'red')
lines(BOE$Date, BOE$StockPrice, type = 'l', col = 'pink')
abline(v = as.Date(c('2000-03-01')), col = 'green', lty = 3)
```
...
lines(CO$Date, CO$StockPrice, type = 'l', col = 'red')
lines(BOE$Date, BOE$StockPrice, type = 'l', col = 'pink')
abline(v = as.Date(c('1983-01-01','1984-01-01')), col = 'green', lty = 3)
```

(b) In the time period shown in the plot, which stock generally has lower values?
```{r}
plot(IBM$Date, IBM$StockPrice, type = 'l', xlim = as.Date(c('1983-01-01','1984-01-01')), ylim = c(0,200))
lines(GE$Date, GE$StockPrice, type = 'l', col = 'blue')
lines(PG$Date, PG$StockPrice, type = 'l', col = 'yellow')
lines(CO$Date, CO$StockPrice, type = 'l', col = 'red')
lines(BOE$Date, BOE$StockPrice, type = 'l', col = 'pink')
...
```{r}
plot(IBM$Date, IBM$StockPrice, type = 'l', xlim = as.Date(c('2000-03-01','2001-01-01')), ylim = c(0,200))
lines(GE$Date, GE$StockPrice, type = 'l', col = 'blue')
lines(PG$Date, PG$StockPrice, type = 'l', col = 'yellow')
lines(CO$Date, CO$StockPrice, type = 'l', col = 'red')
lines(BOE$Date, BOE$StockPrice, type = 'l', col = 'pink')
...
```{r}
plot(IBM$Date, IBM$StockPrice, type = 'l', xlim = as.Date(c('1995-01-01','2006-01-01')), ylim = c(0,250))
lines(GE$Date, GE$StockPrice, type = 'l', col = 'blue')
lines(PG$Date, PG$StockPrice, type = 'l', col = 'yellow')
lines(CO$Date, CO$StockPrice, type = 'l', col = 'red')
lines(BOE$Date, BOE$StockPrice, type = 'l', col = 'pink')
...
```{r}
plot(IBM$Date, IBM$StockPrice, type = 'l', xlim = as.Date(c('1997-09-01','1997-11-01')), ylim = c(0,200))
lines(GE$Date, GE$StockPrice, type = 'l', col = 'blue')
lines(PG$Date, PG$StockPrice, type = 'l', col = 'yellow')
lines(CO$Date, CO$StockPrice, type = 'l', col = 'red')
lines(BOE$Date, BOE$StockPrice, type = 'l', col = 'pink')
...
```{r}
plot(IBM$Date, IBM$StockPrice, type = 'l', xlim = as.Date(c('2004-01-01','2006-01-01')), ylim = c(0,200))
lines(GE$Date, GE$StockPrice, type = 'l', col = 'blue')
lines(PG$Date, PG$StockPrice, type = 'l', col = 'yellow')
lines(CO$Date, CO$StockPrice, type = 'l', col = 'red')
lines(BOE$Date, BOE$StockPrice, type = 'l', col = 'pink')
...
tapply(BOE$StockPrice,format(BOE$Date,'%m'),mean) 
```
