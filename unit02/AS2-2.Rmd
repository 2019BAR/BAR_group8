...
```{r}
IBM = read.csv('C:/BAR_group8/unit02/data/IBMStock.csv')
GE = read.csv('C:/BAR_group8/unit02/data/GEStock.csv')
PG = read.csv('C:/BAR_group8/unit02/data/ProcterGambleStock.csv')
CO = read.csv('C:/BAR_group8/unit02/data/CocaColaStock.csv')
BOE = read.csv('C:/BAR_group8/unit02/data/BoeingStock.csv')
nrow(IBM)
```
